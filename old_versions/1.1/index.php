...
<tr>
	<td align="center">
	<b><a href="<? echo $_SERVER['PHP_SELF'] ?>?destroy=true">Star Over</a></b><br><br>
	<? 
/* ---------------------------------- 
 ...
 */	
	...
	if((!isset($_SESSION['p_drop']) && !isset($_GET['p_drop'])) || $_GET['p_drop'] == "NoNotMe") {
		...
		Welcome to the U.S.H.M.M. Searching Tool.  Please follow the instructions and you will be given search results after 4 simple steps.<br><br>
