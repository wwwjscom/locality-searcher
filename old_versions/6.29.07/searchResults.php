...
else if($checkQueryResultIsOK==1)//Users query is OK, time to do stuff to it. 
{
	...
	if($Pquery_num>0)
	{
		...
		echo "<li>We found the province <a href=\"index.php?p_drop=$tmp&destroy=true\">$tmp</a></li>";
	}
	...
	if($Oquery_num>0)
	{
		...
		echo "<li>We found district <a href=\"index.php?o_drop=$tmp&destroy=true\">$tmp</a></li>";
	}
	...
	if($Mquery_num>0)
	{
		...
		echo "<li>We found municipality <a href=\"index.php?m_drop=$tmp&destroy=true\">$tmp</a></li>";
	}
	...
	if($Tquery_num>0)
	{
		...
		$tmp = mysql_result($Tquery_result,$i,t);
		echo "<li>We found town <a href=\"index.php?t_drop=$tmp&destroy=true\">$tmp</a></li>";
	}
...
?>
<br><br><br><br>
If your word was not found, decrease the spelling accuracy on the drop-down menu and search again below.
<br>
<? displaySearcher(); ?>
</table>
<br>
